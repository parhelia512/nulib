 ...
 */
module nulib.system.win32.commctrl;
...
version (Win64) {
    enum HTREEITEM TVI_ROOT = cast(HTREEITEM) cast(ULONG_PTR)-0x10000,
    ...
    enum HTREEITEM TVI_ROOT = cast(HTREEITEM) 0xFFFF0000,
...
static if (_WIN32_WINNT >= 0x501) {
    ...
    enum size_t TTTOOLINFOA_V1_SIZE = TOOLINFOA.lParam.offsetof,
    ...
    enum size_t TTTOOLINFOA_V1_SIZE = TOOLINFOA.sizeof,
...
version (Unicode) {
    ...
    //alias PCCOMBOBOXEXITEM = PCCOMBOBOXEXITEMW; fixme
    ...
    //alias PCCOMBOBOXEXITEM = PCCOMBOBOXEXITEMA; fixme
