...
*/
module nulib.c.stdint;
import nulib.c.stddef; // for wchar_t
...
T _typify(T)(T val) @nogc @safe pure nothrow {
    return val;
}
...
///
enum wchar_t WINT_MIN = wchar_t.min;
///
enum wchar_t WINT_MAX = wchar_t.max;
