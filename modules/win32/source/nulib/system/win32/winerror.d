 ...
 */
module nulib.system.win32.winerror;
...
alias SCODE = int; // was in nulib.system.win32.wtypes.
...
ushort SCODE_CODE(SCODE r) { return cast(ushort) (r & 0xFFFF); }
ushort SCODE_FACILITY(SCODE r) { return cast(ushort) ((r>>16) & 0x1fff); }
ushort SCODE_SEVERITY(SCODE r) { return cast(ushort) ((r>>31) & 0x1); }
SCODE MAKE_SCODE(bool s, uint f, uint c) { return (s << 31) | (f << 16) | c; }
SCODE GetScode(HRESULT hr) { return hr; }
HRESULT ResultFromScode(SCODE c) { return c; }
HRESULT PropagateResult(HRESULT hrPrevious, SCODE scBase) { return scBase; }
