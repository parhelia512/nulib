 ...
 */
module nulib.system.win32.shlobj;
import nulib.system.win32.commctrl;
import nulib.system.win32.ole2;
import nulib.system.win32.shlguid;
import nulib.system.win32.shellapi;
...
import nulib.system.win32.winnetwk; // for NETRESOURCE
import nulib.system.win32.oaidl : VARIANT;
...
interface IShellFolder : IUnknown {
    HRESULT ParseDisplayName(HWND, LPBINDCTX, LPOLESTR, PULONG, LPITEMIDLIST*, PULONG);
    HRESULT EnumObjects(HWND, DWORD, LPENUMIDLIST*);
    HRESULT BindToObject(LPCITEMIDLIST, LPBINDCTX, REFIID, PVOID*);
    HRESULT BindToStorage(LPCITEMIDLIST, LPBINDCTX, REFIID, PVOID*);
