 ...
 */
module nulib.system.win32.wingdi;
...
import nulib.system.win32.w32api, nulib.system.win32.windef, nulib.system.win32.winver;
...
/* FIXME: move to nulib.system.win32.winuser ? */
// DrawIconEx()
enum : UINT {
    DI_MASK        = 1,
    DI_IMAGE       = 2,
...
/* FIXME: move to nulib.system.win32.commctrl ? */
// ImageList
enum COLORREF
    CLR_NONE    = 0xffffffff,
...
alias FXPT16DOT16 = int;
alias LPFXPT16DOT16 = int*;
alias FXPT2DOT30 = int;
alias LPFXPT2DOT30 = int*;
...
alias LPCIEXYZTRIPLE = CIEXYZTRIPLE*;
...
alias PPSFEATURE_OUTPUT = PSFEATURE_OUTPUT*;
...
alias PPSFEATURE_CUSTPAPER = PSFEATURE_CUSTPAPER*;
...
alias PEMRANGLEARC = EMRANGLEARC*;
...
alias PEMRARC = EMRARC*;
alias EMRARCTO = EMRARC;
alias PEMRARCTO = EMRARCTO*;
alias EMRCHORD = EMRARC;
alias PEMRCHORD = EMRCHORD*;
alias EMRPIE = EMRARC;
alias PEMRPIE = EMRPIE*;
...
alias PEMRCREATEBRUSHINDIRECT = EMRCREATEBRUSHINDIRECT*;
...
alias LPLOGCOLORSPACEA = LOGCOLORSPACEA*;
...
alias LPLOGCOLORSPACEW = LOGCOLORSPACEW*;
...
alias PEMRGLSRECORD = EMRGLSRECORD*;
...
alias PEMRGLSBOUNDEDRECORD = EMRGLSBOUNDEDRECORD*;

struct EMRPIXELFORMAT {
    EMR emr;
    PIXELFORMATDESCRIPTOR pfd;
}
alias PEMRPIXELFORMAT = EMRPIXELFORMAT*;
...
alias PEMRCREATECOLORSPACE = EMRCREATECOLORSPACE*;

struct EMRSETCOLORSPACE {
    EMR emr;
    DWORD ihCS;
}
alias PEMRSETCOLORSPACE = EMRSETCOLORSPACE*;
alias EMRSELECTCOLORSPACE = EMRSETCOLORSPACE;
alias PEMRSELECTCOLORSPACE = EMRSELECTCOLORSPACE*;
alias EMRDELETECOLORSPACE = EMRSETCOLORSPACE;
alias PEMRDELETECOLORSPACE = EMRDELETECOLORSPACE*;
...
static if (_WIN32_WINNT >= 0x500) {
    ...
    alias PEMREXTESCAPE = EMREXTESCAPE*;
    alias EMRDRAWESCAPE = EMREXTESCAPE;
    alias PEMRDRAWESCAPE = EMRDRAWESCAPE*;
    ...
    alias PEMRNAMEDESCAPE = EMRNAMEDESCAPE*;
    ...
    alias PEMRSETICMPROFILE = EMRSETICMPROFILE*;
    alias EMRSETICMPROFILEA = EMRSETICMPROFILE;
    alias PEMRSETICMPROFILEA = EMRSETICMPROFILEA*;
    alias EMRSETICMPROFILEW = EMRSETICMPROFILE;
    alias PEMRSETICMPROFILEW = EMRSETICMPROFILEW*;
    ...
    alias PEMRCREATECOLORSPACEW = EMRCREATECOLORSPACEW*;
    ...
    alias PEMRCOLORMATCHTOTARGET = EMRCOLORMATCHTOTARGET*;
    ...
    alias PEMRCOLORCORRECTPALETTE = EMRCOLORCORRECTPALETTE*;
    ...
    alias PEMRALPHABLEND = EMRALPHABLEND*;
    ...
    alias PEMRGRADIENTFILL = EMRGRADIENTFILL*;
    ...
    alias PEMRTRANSPARENTBLT = EMRTRANSPARENTBLT*;
}
...
alias PEMRCREATEDIBPATTERNBRUSHPT = EMRCREATEDIBPATTERNBRUSHPT*;
...
alias PEMRCREATEMONOBRUSH = EMRCREATEMONOBRUSH*;
...
alias PEMRCREATEPALETTE = EMRCREATEPALETTE*;
...
alias PEMRCREATEPEN = EMRCREATEPEN*;

struct EMRELLIPSE {
    EMR emr;
    RECTL rclBox;
}
alias PEMRELLIPSE = EMRELLIPSE*;

alias EMRRECTANGLE = EMRELLIPSE;
alias PEMRRECTANGLE = EMRRECTANGLE*;
...
alias PEMREOF = EMREOF*;

struct EMREXCLUDECLIPRECT {
    EMR emr;
    RECTL rclClip;
}
alias PEMREXCLUDECLIPRECT = EMREXCLUDECLIPRECT*;
alias EMRINTERSECTCLIPRECT = EMREXCLUDECLIPRECT;
alias PEMRINTERSECTCLIPRECT = EMRINTERSECTCLIPRECT*;
...
alias PEMREXTCREATEFONTINDIRECTW = EMREXTCREATEFONTINDIRECTW*;
...
alias PEMREXTCREATEPEN = EMREXTCREATEPEN*;
...
alias PEMREXTFLOODFILL = EMREXTFLOODFILL*;
...
alias PEMREXTSELECTCLIPRGN = EMREXTSELECTCLIPRGN*;
...
alias PEMREXTTEXTOUTA = EMREXTTEXTOUTA*;
alias EMREXTTEXTOUTW = EMREXTTEXTOUTA;
alias PEMREXTTEXTOUTW = EMREXTTEXTOUTW*;

struct EMRFILLPATH {
    EMR emr;
    RECTL rclBounds;
}
alias PEMRFILLPATH = EMRFILLPATH*;

alias EMRSTROKEANDFILLPATH = EMRFILLPATH;
alias PEMRSTROKEANDFILLPATH = EMRSTROKEANDFILLPATH*;

alias EMRSTROKEPATH = EMRFILLPATH;
alias PEMRSTROKEPATH = EMRSTROKEPATH*;
...
alias PEMRFRAMERGN = EMRFRAMERGN*;
...
alias PEMRGDICOMMENT = EMRGDICOMMENT*;
...
alias PEMRINVERTRGN = EMRINVERTRGN*;
alias EMRPAINTRGN = EMRINVERTRGN;
alias PEMRPAINTRGN = EMRPAINTRGN*;

struct EMRLINETO {
    EMR emr;
    POINTL ptl;
}
alias PEMRLINETO = EMRLINETO*;
alias EMRMOVETOEX = EMRLINETO;
alias PEMRMOVETOEX = EMRMOVETOEX*;
...
alias PEMRMODIFYWORLDTRANSFORM = EMRMODIFYWORLDTRANSFORM*;

struct EMROFFSETCLIPRGN {
    EMR emr;
    POINTL ptlOffset;
}
alias PEMROFFSETCLIPRGN = EMROFFSETCLIPRGN*;
...
alias PEMRPOLYDRAW = EMRPOLYDRAW*;
...
alias PEMRPOLYDRAW16 = EMRPOLYDRAW16*;
...
alias PEMRPOLYLINE = EMRPOLYLINE*;
alias EMRPOLYBEZIER = EMRPOLYLINE;
alias PEMRPOLYBEZIER = EMRPOLYBEZIER*;
alias EMRPOLYGON = EMRPOLYLINE;
alias PEMRPOLYGON = EMRPOLYGON*;
alias EMRPOLYBEZIERTO = EMRPOLYLINE;
alias PEMRPOLYBEZIERTO = EMRPOLYBEZIERTO*;
alias EMRPOLYLINETO = EMRPOLYLINE;
alias PEMRPOLYLINETO = EMRPOLYLINETO*;
...
alias PEMRPOLYLINE16 = EMRPOLYLINE16*;
alias EMRPOLYBEZIER16 = EMRPOLYLINE16;
alias PEMRPOLYBEZIER16 = EMRPOLYBEZIER16*;
alias EMRPOLYGON16 = EMRPOLYLINE16;
alias PEMRPOLYGON16 = EMRPOLYGON16*;
alias EMRPOLYBEZIERTO16 = EMRPOLYLINE16;
alias PEMRPOLYBEZIERTO16 = EMRPOLYBEZIERTO16*;
alias EMRPOLYLINETO16 = EMRPOLYLINE16;
alias PEMRPOLYLINETO16 = EMRPOLYLINETO16*;
...
alias PEMRPOLYPOLYLINE = EMRPOLYPOLYLINE*;
alias EMRPOLYPOLYGON = EMRPOLYPOLYLINE;
alias PEMRPOLYPOLYGON = EMRPOLYPOLYGON*;
...
alias PEMRPOLYPOLYLINE16 = EMRPOLYPOLYLINE16*;
alias EMRPOLYPOLYGON16 = EMRPOLYPOLYLINE16;
alias PEMRPOLYPOLYGON16 = EMRPOLYPOLYGON16*;
...
alias PEMRPOLYTEXTOUTA = EMRPOLYTEXTOUTA*;
alias EMRPOLYTEXTOUTW = EMRPOLYTEXTOUTA;
alias PEMRPOLYTEXTOUTW = EMRPOLYTEXTOUTW*;
...
alias PEMRRESIZEPALETTE = EMRRESIZEPALETTE*;

struct EMRRESTOREDC {
    EMR emr;
    LONG iRelative;
}
alias PEMRRESTOREDC = EMRRESTOREDC*;
...
alias PEMRSCALEVIEWPORTEXTEX = EMRSCALEVIEWPORTEXTEX*;
alias EMRSCALEWINDOWEXTEX = EMRSCALEVIEWPORTEXTEX;
alias PEMRSCALEWINDOWEXTEX = EMRSCALEWINDOWEXTEX*;

struct EMRSELECTOBJECT {
    EMR emr;
    DWORD ihObject;
}
alias PEMRSELECTOBJECT = EMRSELECTOBJECT*;
alias EMRDELETEOBJECT = EMRSELECTOBJECT;
alias PEMRDELETEOBJECT = EMRDELETEOBJECT*;

struct EMRSELECTPALETTE {
    EMR emr;
    DWORD ihPal;
}
alias PEMRSELECTPALETTE = EMRSELECTPALETTE*;

struct EMRSETARCDIRECTION {
    EMR emr;
    DWORD iArcDirection;
}
alias PEMRSETARCDIRECTION = EMRSETARCDIRECTION*;

struct EMRSETTEXTCOLOR {
    EMR emr;
    COLORREF crColor;
}
alias PEMRSETTEXTCOLOR = EMRSETTEXTCOLOR*;
alias EMRSETBKCOLOR = EMRSETTEXTCOLOR;
alias PEMRSETBKCOLOR = EMRSETBKCOLOR*;

struct EMRSETCOLORADJUSTMENT {
    EMR emr;
    COLORADJUSTMENT ColorAdjustment;
}
alias PEMRSETCOLORADJUSTMENT = EMRSETCOLORADJUSTMENT*;
...
alias PEMRSETDIBITSTODEVICE = EMRSETDIBITSTODEVICE*;

struct EMRSETMAPPERFLAGS {
    EMR emr;
    DWORD dwFlags;
}
alias PEMRSETMAPPERFLAGS = EMRSETMAPPERFLAGS*;

struct EMRSETMITERLIMIT {
    EMR emr;
    FLOAT eMiterLimit;
}
alias PEMRSETMITERLIMIT = EMRSETMITERLIMIT*;
...
alias PEMRSETPALETTEENTRIES = EMRSETPALETTEENTRIES*;
...
alias PEMRSETPIXELV = EMRSETPIXELV*;

struct EMRSETVIEWPORTEXTEX {
    EMR emr;
    SIZEL szlExtent;
}
alias PEMRSETVIEWPORTEXTEX = EMRSETVIEWPORTEXTEX*;
alias EMRSETWINDOWEXTEX = EMRSETVIEWPORTEXTEX;
...
alias PEMRSETVIEWPORTORGEX = EMRSETVIEWPORTORGEX*;
alias EMRSETWINDOWORGEX = EMRSETVIEWPORTORGEX;
alias PEMRSETWINDOWORGEX = EMRSETWINDOWORGEX*;
alias EMRSETBRUSHORGEX = EMRSETVIEWPORTORGEX;
alias PEMRSETBRUSHORGEX = EMRSETBRUSHORGEX*;

struct EMRSETWORLDTRANSFORM {
    EMR emr;
    XFORM xform;
}
alias PEMRSETWORLDTRANSFORM = EMRSETWORLDTRANSFORM*;
...
alias PEMRSTRETCHBLT = EMRSTRETCHBLT*;
...
alias PEMRSTRETCHDIBITS = EMRSTRETCHDIBITS*;

struct EMRABORTPATH {
    EMR emr;
}
alias PEMRABORTPATH = EMRABORTPATH*;
alias EMRBEGINPATH = EMRABORTPATH;
alias PEMRBEGINPATH = EMRBEGINPATH*;
alias EMRENDPATH = EMRABORTPATH;
alias PEMRENDPATH = EMRENDPATH*;
alias EMRCLOSEFIGURE = EMRABORTPATH;
alias PEMRCLOSEFIGURE = EMRCLOSEFIGURE*;
alias EMRFLATTENPATH = EMRABORTPATH;
alias PEMRFLATTENPATH = EMRFLATTENPATH*;
alias EMRWIDENPATH = EMRABORTPATH;
alias PEMRWIDENPATH = EMRWIDENPATH*;
alias EMRSETMETARGN = EMRABORTPATH;
alias PEMRSETMETARGN = EMRSETMETARGN*;
alias EMRSAVEDC = EMRABORTPATH;
alias PEMRSAVEDC = EMRSAVEDC*;
alias EMRREALIZEPALETTE = EMRABORTPATH;
alias PEMRREALIZEPALETTE = EMRREALIZEPALETTE*;

struct EMRSELECTCLIPPATH {
    EMR emr;
    DWORD iMode;
}
alias PEMRSELECTCLIPPATH = EMRSELECTCLIPPATH*;
alias EMRSETBKMODE = EMRSELECTCLIPPATH;
alias PEMRSETBKMODE = EMRSETBKMODE*;
alias EMRSETMAPMODE = EMRSELECTCLIPPATH;
alias PEMRSETMAPMODE = EMRSETMAPMODE*;
alias EMRSETPOLYFILLMODE = EMRSELECTCLIPPATH;
alias PEMRSETPOLYFILLMODE = EMRSETPOLYFILLMODE*;
alias EMRSETROP2 = EMRSELECTCLIPPATH;
alias PEMRSETROP2 = EMRSETROP2*;
alias EMRSETSTRETCHBLTMODE = EMRSELECTCLIPPATH;
alias PEMRSETSTRETCHBLTMODE = EMRSETSTRETCHBLTMODE*;
alias EMRSETICMMODE = EMRSELECTCLIPPATH;
alias PEMRSETICMMODE = EMRSETICMMODE*;
alias EMRSETTEXTALIGN = EMRSELECTCLIPPATH;
alias PEMRSETTEXTALIGN = EMRSETTEXTALIGN*;
alias EMRENABLEICM = EMRSELECTCLIPPATH;
alias PEMRENABLEICM = EMRENABLEICM*;
static if (_WIN32_WINNT >= 0x500) {
    alias EMRSETLAYOUT = EMRSELECTCLIPPATH;
    alias PEMRSETLAYOUT = EMRSETLAYOUT*;
}
...
alias PMETARECORD = METARECORD*;
alias LPMETARECORD = METARECORD*;
...
alias PRGNDATAHEADER = RGNDATAHEADER*;
...
alias LPGCP_RESULTSA = GCP_RESULTSA*;
...
alias LPGCP_RESULTSW = GCP_RESULTSW*;
...
alias LPGLYPHMETRICS = GLYPHMETRICS*;
...
alias LPKERNINGPAIR = KERNINGPAIR*;
...
alias LPRASTERIZER_STATUS = RASTERIZER_STATUS*;
...
alias LPMETAFILEPICT = METAFILEPICT*;
...
alias LCSTYPE = LONG; /* What this for? */
...
alias LPENUMLOGFONTA = ENUMLOGFONTA*;
...
alias LPENUMLOGFONTW = ENUMLOGFONTW*;
...
alias LPENUMLOGFONTEXA = ENUMLOGFONTEXA*;
...
alias LPENUMLOGFONTEXW = ENUMLOGFONTEXW*;

struct POINTFX {
    FIXED x;
    FIXED y;
}
alias LPPOINTFX = POINTFX*;
...
alias LPTTPOLYCURVE = TTPOLYCURVE*;
...
alias LPTTPOLYGONHEADER = TTPOLYGONHEADER*;

struct POINTFLOAT {
    FLOAT x;
    FLOAT y;
}
alias PPOINTFLOAT = POINTFLOAT*;
...
enum MM_MAX_AXES_NAMELEN = 16;
    ...
    version (Unicode) {
        alias AXISINFO = AXISINFOW;
        alias PAXISINFO = PAXISINFOW;
        alias LPAXISINFO = LPAXISINFOW;
    }
    else {
    ...
    version (Unicode) {
        ...
        alias PAXESLIST = PAXESLISTW;
        alias LPAXESLIST = LPAXESLISTW;
    }
    else {
...
extern(Windows) nothrow @nogc {
    ...
    version (Unicode)
        alias CreateFontIndirectEx = CreateFontIndirectExW;
    else
        alias CreateFontIndirectEx = CreateFontIndirectExA;
    ...
    version (Unicode) {
        alias ENUMTEXTMETRIC = ENUMTEXTMETRICW;
        alias PENUMTEXTMETRIC = PENUMTEXTMETRICW;
        alias LPENUMTEXTMETRIC = LPENUMTEXTMETRICW;
    }
    else {
...
alias PDRAWPATRECT = DRAWPATRECT*;
...
version (Unicode) {
    alias BCHAR = WCHAR;
    alias DOCINFO = DOCINFOW;
    alias LOGFONT = LOGFONTW;

    alias TEXTMETRIC = TEXTMETRICW;
    alias NPTEXTMETRIC = NPTEXTMETRICW;
    alias ICMENUMPROC = ICMENUMPROCW;
    alias FONTENUMPROC = FONTENUMPROCW;
    alias DEVMODE = DEVMODEW;

    alias EXTLOGFONT = EXTLOGFONTW;
    alias GCP_RESULTS = GCP_RESULTSW;
    alias OUTLINETEXTMETRIC = OUTLINETEXTMETRICW;
    alias POLYTEXT = POLYTEXTW;
    alias LOGCOLORSPACE = LOGCOLORSPACEW;
    alias NEWTEXTMETRIC = NEWTEXTMETRICW;
    alias NEWTEXTMETRICEX = NEWTEXTMETRICEXW;
    alias ENUMLOGFONT = ENUMLOGFONTW;
    alias ENUMLOGFONTEX = ENUMLOGFONTEXW;
    alias DISPLAY_DEVICE = DISPLAY_DEVICEW;
    alias AddFontResource = AddFontResourceW;

    alias CopyEnhMetaFile = CopyEnhMetaFileW;
    alias CopyMetaFile = CopyMetaFileW;
    alias CreateColorSpace = CreateColorSpaceW;
    alias CreateDC = CreateDCW;
    alias CreateEnhMetaFile = CreateEnhMetaFileW;
    alias CreateFont = CreateFontW;
    alias CreateFontIndirect = CreateFontIndirectW;
    alias CreateIC = CreateICW;
    alias CreateMetaFile = CreateMetaFileW;
    alias CreateScalableFontResource = CreateScalableFontResourceW;
    alias DeviceCapabilities = DeviceCapabilitiesW;
    alias EnumFontFamilies = EnumFontFamiliesW;
    alias EnumFontFamiliesEx = EnumFontFamiliesExW;
    alias EnumFonts = EnumFontsW;
    alias EnumICMProfiles = EnumICMProfilesW;
    alias ExtTextOut = ExtTextOutW;
    alias GetCharABCWidthsFloat = GetCharABCWidthsFloatW;
    alias GetCharABCWidths = GetCharABCWidthsW;
    alias GetCharacterPlacement = GetCharacterPlacementW;
    alias GetCharWidth32 = GetCharWidth32W;
    alias GetCharWidthFloat = GetCharWidthFloatW;
    alias GetCharWidth = GetCharWidthW;
    alias GetEnhMetaFile = GetEnhMetaFileW;
    alias GetEnhMetaFileDescription = GetEnhMetaFileDescriptionW;
    alias GetGlyphOutline = GetGlyphOutlineW;
    alias GetICMProfile = GetICMProfileW;
    alias GetKerningPairs = GetKerningPairsW;
    alias GetLogColorSpace = GetLogColorSpaceW;
    alias GetMetaFile = GetMetaFileW;
    alias GetObject = GetObjectW;
    alias GetOutlineTextMetrics = GetOutlineTextMetricsW;
    alias GetTextExtentPoint = GetTextExtentPointW;
    alias GetTextExtentExPoint = GetTextExtentExPointW;
    alias GetTextExtentPoint32 = GetTextExtentPoint32W;
    alias GetTextFace = GetTextFaceW;
    alias GetTextMetrics = GetTextMetricsW;
    alias PolyTextOut = PolyTextOutW;
    alias RemoveFontResource = RemoveFontResourceW;

    alias ResetDC = ResetDCW;
    alias SetICMProfile = SetICMProfileW;
    alias StartDoc = StartDocW;
    alias TextOut = TextOutW;
    alias UpdateICMRegKey = UpdateICMRegKeyW;
    alias wglUseFontBitmaps = wglUseFontBitmapsW;
    alias wglUseFontOutlines = wglUseFontOutlinesW;
    static if (_WIN32_WINNT >= 0x500) {
        alias ENUMLOGFONTEXDV = ENUMLOGFONTEXDVW;
        alias PENUMLOGFONTEXDV = PENUMLOGFONTEXDVW;
        alias LPENUMLOGFONTEXDV = LPENUMLOGFONTEXDVW;
        alias AddFontResourceEx = AddFontResourceExW;
        alias RemoveFontResourceEx = RemoveFontResourceExW;
        alias GetGlyphIndices = GetGlyphIndicesW;
    }
    ...
    alias ICMENUMPROC = ICMENUMPROCA;
    ...
    alias AddFontResource = AddFontResourceA;
    alias CopyEnhMetaFile = CopyEnhMetaFileA;
    alias CopyMetaFile = CopyMetaFileA;
    alias CreateColorSpace = CreateColorSpaceA;
    alias CreateDC = CreateDCA;
    alias CreateEnhMetaFile = CreateEnhMetaFileA;
    alias CreateFont = CreateFontA;
    alias CreateFontIndirect = CreateFontIndirectA;
    alias CreateIC = CreateICA;
    alias CreateMetaFile = CreateMetaFileA;
    alias CreateScalableFontResource = CreateScalableFontResourceA;
    alias DeviceCapabilities = DeviceCapabilitiesA;
    alias EnumFontFamilies = EnumFontFamiliesA;
    alias EnumFontFamiliesEx = EnumFontFamiliesExA;
    alias EnumFonts = EnumFontsA;
    alias EnumICMProfiles = EnumICMProfilesA;
    alias ExtTextOut = ExtTextOutA;
    alias GetCharWidthFloat = GetCharWidthFloatA;
    alias GetCharWidth = GetCharWidthA;
    alias GetCharacterPlacement = GetCharacterPlacementA;
    alias GetCharABCWidths = GetCharABCWidthsA;
    alias GetCharABCWidthsFloat = GetCharABCWidthsFloatA;
    alias GetCharWidth32 = GetCharWidth32A;
    alias GetEnhMetaFile = GetEnhMetaFileA;
    alias GetEnhMetaFileDescription = GetEnhMetaFileDescriptionA;
    alias GetGlyphOutline = GetGlyphOutlineA;
    alias GetICMProfile = GetICMProfileA;
    alias GetKerningPairs = GetKerningPairsA;
    alias GetLogColorSpace = GetLogColorSpaceA;
    alias GetMetaFile = GetMetaFileA;
    alias GetObject = GetObjectA;
    alias GetOutlineTextMetrics = GetOutlineTextMetricsA;
    alias GetTextExtentPoint = GetTextExtentPointA;
    alias GetTextExtentExPoint = GetTextExtentExPointA;
    alias GetTextExtentPoint32 = GetTextExtentPoint32A;
    alias GetTextFace = GetTextFaceA;
    alias GetTextMetrics = GetTextMetricsA;
    alias PolyTextOut = PolyTextOutA;
    alias RemoveFontResource = RemoveFontResourceA;
    alias ResetDC = ResetDCA;
    alias SetICMProfile = SetICMProfileA;
    alias StartDoc = StartDocA;
    alias TextOut = TextOutA;
    alias UpdateICMRegKey = UpdateICMRegKeyA;
    alias wglUseFontBitmaps = wglUseFontBitmapsA;
    alias wglUseFontOutlines = wglUseFontOutlinesA;
    static if (_WIN32_WINNT >= 0x500) {
        alias ENUMLOGFONTEXDV = ENUMLOGFONTEXDVA;
        alias PENUMLOGFONTEXDV = PENUMLOGFONTEXDVA;
        alias LPENUMLOGFONTEXDV = LPENUMLOGFONTEXDVA;
        alias AddFontResourceEx = AddFontResourceExA;
        alias RemoveFontResourceEx = RemoveFontResourceExA;
        alias GetGlyphIndices = GetGlyphIndicesA;
    }
}

// Common to both ASCII & UNICODE
alias LPDOCINFO = DOCINFO*;
...
alias LPGCP_RESULTS = GCP_RESULTS*;
...
alias LPLOGCOLORSPACE = LOGCOLORSPACE*;
alias NEWTEXTMETRIC* PNEWTEXTMETRIC, NPNEWTEXTMETRIC, LPNEWTEXTMETRIC;
alias LPENUMLOGFONT = ENUMLOGFONT*;
alias LPENUMLOGFONTEX = ENUMLOGFONTEX*;
