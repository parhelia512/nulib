 ...
 */
module nulib.system.win32.winnt;


version (ANSI) {} else version = Unicode;

public import nulib.system.win32.basetsd, nulib.system.win32.windef, nulib.system.win32.winerror;
...
alias LP = TCHAR*;
alias PTCHAR = TCHAR*;
alias PCTCH = const(TCHAR)*;
alias LPCTCH = const(TCHAR)*;
alias PCTSTR = const(TCHAR)*;
alias LPCTSTR = const(TCHAR)*;
...
alias PSECURITY_IMPERSONATION_LEVEL = SECURITY_IMPERSONATION_LEVEL*;

alias SECURITY_CONTEXT_TRACKING_MODE = BOOLEAN;
alias PSECURITY_CONTEXT_TRACKING_MODE = BOOLEAN*;
...
/* also in nulib.system.win32.basetyps
struct GUID {
    uint  Data1;
    ushort Data2;
    ushort Data3;
...
alias PGENERIC_MAPPING = GENERIC_MAPPING*;
...
alias PACCESS_ALLOWED_ACE = ACCESS_ALLOWED_ACE*;
...
alias PACCESS_DENIED_ACE = ACCESS_DENIED_ACE*;
...
alias PSYSTEM_ALARM_ACE = SYSTEM_ALARM_ACE*;
...
alias PACCESS_ALLOWED_OBJECT_ACE = ACCESS_ALLOWED_OBJECT_ACE*;
...
alias PACCESS_DENIED_OBJECT_ACE = ACCESS_DENIED_OBJECT_ACE*;
...
alias PSYSTEM_AUDIT_OBJECT_ACE = SYSTEM_AUDIT_OBJECT_ACE*;
...
alias PSYSTEM_ALARM_OBJECT_ACE = SYSTEM_ALARM_OBJECT_ACE*;
...
alias LPEXCEPTION_RECORD = EXCEPTION_RECORD*;
...
alias LPEXCEPTION_POINTERS = EXCEPTION_POINTERS*;
...
alias PLUID_AND_ATTRIBUTES = LUID_AND_ATTRIBUTES*;
...
alias PPRIVILEGE_SET = PRIVILEGE_SET*;
...
alias PSECURITY_QUALITY_OF_SERVICE = SECURITY_QUALITY_OF_SERVICE*;
...
alias PSE_IMPERSONATION_STATE = SE_IMPERSONATION_STATE*;

struct SID_IDENTIFIER_AUTHORITY {
    BYTE[6] Value;
}
alias PSID_IDENTIFIER_AUTHORITY = SID_IDENTIFIER_AUTHORITY*;
alias LPSID_IDENTIFIER_AUTHORITY = SID_IDENTIFIER_AUTHORITY*;
...
alias PSID_AND_ATTRIBUTES = SID_AND_ATTRIBUTES*;

struct TOKEN_SOURCE {
    CHAR[TOKEN_SOURCE_LENGTH] SourceName = 0;
    LUID SourceIdentifier;
}
alias PTOKEN_SOURCE = TOKEN_SOURCE*;
...
alias PTOKEN_CONTROL = TOKEN_CONTROL*;

struct TOKEN_DEFAULT_DACL {
    PACL DefaultDacl;
}
alias PTOKEN_DEFAULT_DACL = TOKEN_DEFAULT_DACL*;
...
alias PTOKEN_GROUPS = TOKEN_GROUPS*;
alias LPTOKEN_GROUPS = TOKEN_GROUPS*;

struct TOKEN_OWNER {
    PSID Owner;
}
alias PTOKEN_OWNER = TOKEN_OWNER*;
enum SECURITY_MAX_SID_SIZE = 68;

struct TOKEN_PRIMARY_GROUP {
    PSID PrimaryGroup;
}
alias PTOKEN_PRIMARY_GROUP = TOKEN_PRIMARY_GROUP*;
...
alias PTOKEN_PRIVILEGES = TOKEN_PRIVILEGES*;
alias LPTOKEN_PRIVILEGES = TOKEN_PRIVILEGES*;

enum TOKEN_TYPE {
    TokenPrimary = 1,
    TokenImpersonation
}
alias PTOKEN_TYPE = TOKEN_TYPE*;
...
alias PTOKEN_STATISTICS = TOKEN_STATISTICS*;

struct TOKEN_USER {
    SID_AND_ATTRIBUTES User;
}
alias PTOKEN_USER = TOKEN_USER*;
...
alias PSECURITY_INFORMATION = SECURITY_INFORMATION*;
alias SECURITY_DESCRIPTOR_CONTROL = WORD;
alias PSECURITY_DESCRIPTOR_CONTROL = SECURITY_DESCRIPTOR_CONTROL*;
...
alias PISECURITY_DESCRIPTOR = SECURITY_DESCRIPTOR*;
...
alias PSID_NAME_USE = SID_NAME_USE*;
...
alias PQUOTA_LIMITS = QUOTA_LIMITS*;
...
alias PIO_COUNTERS = IO_COUNTERS*;
...
alias PTAPE_GET_DRIVE_PARAMETERS = TAPE_GET_DRIVE_PARAMETERS*;
...
alias PTAPE_GET_MEDIA_PARAMETERS = TAPE_GET_MEDIA_PARAMETERS*;
...
alias PTAPE_GET_POSITION = TAPE_GET_POSITION*;

struct TAPE_PREPARE {
    DWORD   Operation;
    BOOLEAN Immediate;
}
alias PTAPE_PREPARE = TAPE_PREPARE*;
...
alias PTAPE_SET_DRIVE_PARAMETERS = TAPE_SET_DRIVE_PARAMETERS*;

struct TAPE_SET_MEDIA_PARAMETERS {
    ULONG BlockSize;
}
alias PTAPE_SET_MEDIA_PARAMETERS = TAPE_SET_MEDIA_PARAMETERS*;
...
alias PTAPE_WRITE_MARKS = TAPE_WRITE_MARKS*;
...
alias PTAPE_CREATE_PARTITION = TAPE_CREATE_PARTITION*;
...
alias PMESSAGE_RESOURCE_ENTRY = MESSAGE_RESOURCE_ENTRY*;
...
alias PMESSAGE_RESOURCE_BLOCK = MESSAGE_RESOURCE_BLOCK*;
...
alias PMESSAGE_RESOURCE_DATA = MESSAGE_RESOURCE_DATA*;
...
version (Win64) {
    ...
    alias SLIST_ENTRY = SINGLE_LIST_ENTRY;
}
alias PSINGLE_LIST_ENTRY = SINGLE_LIST_ENTRY*;
alias PSLIST_ENTRY = SINGLE_LIST_ENTRY*;
...
alias PSLIST_HEADER = SLIST_HEADER*;
...
alias PEVENTLOGRECORD = EVENTLOGRECORD*;
...
alias POSVERSIONINFOA = OSVERSIONINFOA*;
...
alias POSVERSIONINFOW = OSVERSIONINFOW*;
alias LPOSVERSIONINFOW = OSVERSIONINFOW*;
...
alias POSVERSIONINFOEXA = OSVERSIONINFOEXA*;
alias LPOSVERSIONINFOEXA = OSVERSIONINFOEXA*;
...
alias POSVERSIONINFOEXW = OSVERSIONINFOEXW*;
alias LPOSVERSIONINFOEXW = OSVERSIONINFOEXW*;
...
alias PIMAGE_VXD_HEADER = IMAGE_VXD_HEADER*;
...
alias PIMAGE_OPTIONAL_HEADER64 = IMAGE_OPTIONAL_HEADER64*;
...
alias PIMAGE_ROM_OPTIONAL_HEADER = IMAGE_ROM_OPTIONAL_HEADER*;
...
alias PIMAGE_OS2_HEADER = IMAGE_OS2_HEADER*;
...
alias PIMAGE_NT_HEADERS64 = IMAGE_NT_HEADERS64*;

struct IMAGE_ROM_HEADERS {
    IMAGE_FILE_HEADER         FileHeader;
    IMAGE_ROM_OPTIONAL_HEADER OptionalHeader;
}
alias PIMAGE_ROM_HEADERS = IMAGE_ROM_HEADERS*;
...
alias PIMAGE_SYMBOL = IMAGE_SYMBOL*;
...
alias PIMAGE_AUX_SYMBOL = IMAGE_AUX_SYMBOL*;
...
alias PIMAGE_COFF_SYMBOLS_HEADER = IMAGE_COFF_SYMBOLS_HEADER*;
...
alias PIMAGE_RELOCATION = IMAGE_RELOCATION*;

align(4) struct IMAGE_BASE_RELOCATION {
    DWORD VirtualAddress;
    DWORD SizeOfBlock;
}
alias PIMAGE_BASE_RELOCATION = IMAGE_BASE_RELOCATION*;
...
alias PIMAGE_LINENUMBER = IMAGE_LINENUMBER*;
...
alias PIMAGE_ARCHIVE_MEMBER_HEADER = IMAGE_ARCHIVE_MEMBER_HEADER*;
...
alias PIMAGE_EXPORT_DIRECTORY = IMAGE_EXPORT_DIRECTORY*;
...
alias PIMAGE_IMPORT_BY_NAME = IMAGE_IMPORT_BY_NAME*;
...
alias PIMAGE_THUNK_DATA32 = IMAGE_THUNK_DATA32*;
...
alias PIMAGE_THUNK_DATA64 = IMAGE_THUNK_DATA64*;
...
alias PIMAGE_BOUND_IMPORT_DESCRIPTOR = IMAGE_BOUND_IMPORT_DESCRIPTOR*;
...
alias PIMAGE_BOUND_FORWARDER_REF = IMAGE_BOUND_FORWARDER_REF*;
...
alias PIMAGE_TLS_DIRECTORY32 = IMAGE_TLS_DIRECTORY32*;
...
alias PIMAGE_TLS_DIRECTORY64 = IMAGE_TLS_DIRECTORY64*;
...
alias PIMAGE_RESOURCE_DIRECTORY = IMAGE_RESOURCE_DIRECTORY*;
...
alias PIMAGE_RESOURCE_DIRECTORY_ENTRY = IMAGE_RESOURCE_DIRECTORY_ENTRY*;
...
alias PIMAGE_RESOURCE_DIRECTORY_STRING = IMAGE_RESOURCE_DIRECTORY_STRING*;
...
alias PIMAGE_RESOURCE_DIR_STRING_U = IMAGE_RESOURCE_DIR_STRING_U*;
...
alias PIMAGE_RESOURCE_DATA_ENTRY = IMAGE_RESOURCE_DATA_ENTRY*;
...
alias PIMAGE_LOAD_CONFIG_DIRECTORY = IMAGE_LOAD_CONFIG_DIRECTORY*;
...
alias PIMAGE_RUNTIME_FUNCTION_ENTRY = IMAGE_RUNTIME_FUNCTION_ENTRY*;
...
alias PIMAGE_CE_RUNTIME_FUNCTION_ENTRY = IMAGE_CE_RUNTIME_FUNCTION_ENTRY*;
...
alias PIMAGE_DEBUG_DIRECTORY = IMAGE_DEBUG_DIRECTORY*;
...
alias PIMAGE_DEBUG_MISC = IMAGE_DEBUG_MISC*;
...
alias PIMAGE_FUNCTION_ENTRY = IMAGE_FUNCTION_ENTRY*;
...
alias PIMAGE_FUNCTION_ENTRY64 = IMAGE_FUNCTION_ENTRY64*;
...
alias PIMAGE_SEPARATE_DEBUG_HEADER = IMAGE_SEPARATE_DEBUG_HEADER*;
...
alias EXCEPTION_REGISTRATION_RECORD = void;
...
alias PREPARSE_GUID_DATA_BUFFER = REPARSE_GUID_DATA_BUFFER*;
...
alias PREPARSE_POINT_INFORMATION = REPARSE_POINT_INFORMATION*;

union FILE_SEGMENT_ELEMENT {
    PVOID64   Buffer;
    ULONGLONG Alignment;
}
alias PFILE_SEGMENT_ELEMENT = FILE_SEGMENT_ELEMENT*;
...
alias PJOBOBJECT_BASIC_LIMIT_INFORMATION = JOBOBJECT_BASIC_LIMIT_INFORMATION*;
...
alias PJOBOBJECT_BASIC_PROCESS_ID_LIST = JOBOBJECT_BASIC_PROCESS_ID_LIST*;

struct JOBOBJECT_BASIC_UI_RESTRICTIONS {
    DWORD UIRestrictionsClass;
}
alias PJOBOBJECT_BASIC_UI_RESTRICTIONS = JOBOBJECT_BASIC_UI_RESTRICTIONS*;
...
alias PJOBOBJECT_SECURITY_LIMIT_INFORMATION = JOBOBJECT_SECURITY_LIMIT_INFORMATION*;

struct JOBOBJECT_END_OF_JOB_TIME_INFORMATION {
    DWORD EndOfJobTimeAction;
}
alias PJOBOBJECT_END_OF_JOB_TIME_INFORMATION = JOBOBJECT_END_OF_JOB_TIME_INFORMATION*;

struct JOBOBJECT_ASSOCIATE_COMPLETION_PORT {
    PVOID  CompletionKey;
    HANDLE CompletionPort;
}
alias PJOBOBJECT_ASSOCIATE_COMPLETION_PORT = JOBOBJECT_ASSOCIATE_COMPLETION_PORT*;
...
alias PJOBOBJECT_EXTENDED_LIMIT_INFORMATION = JOBOBJECT_EXTENDED_LIMIT_INFORMATION*;

struct JOBOBJECT_JOBSET_INFORMATION {
    DWORD MemberLevel;
}
alias PJOBOBJECT_JOBSET_INFORMATION = JOBOBJECT_JOBSET_INFORMATION*;
...
alias PLATENCY_TIME = LATENCY_TIME*;
...
alias PSYSTEM_POWER_STATE = SYSTEM_POWER_STATE*;
...
static if (_WIN32_WINNT >= 0x600) {
    ...
    alias PSYSTEM_POWER_CONDITION = SYSTEM_POWER_CONDITION*;
}
...
alias PDEVICE_POWER_STATE = DEVICE_POWER_STATE*;
...
alias PSYSTEM_POWER_POLICY = SYSTEM_POWER_POLICY*;
...
alias PSYSTEM_POWER_INFORMATION = SYSTEM_POWER_INFORMATION*;
//#endif
...
alias PPROCESSOR_POWER_POLICY_INFO = PROCESSOR_POWER_POLICY_INFO*;
...
alias PPROCESSOR_POWER_POLICY = PROCESSOR_POWER_POLICY*;
...
alias PADMINISTRATOR_POWER_POLICY = ADMINISTRATOR_POWER_POLICY*;
...
static if (_WIN32_WINNT >= 0x501) {
    ...
    alias PCACTIVATION_CONTEXT_QUERY_INDEX = const(ACTIVATION_CONTEXT_QUERY_INDEX)*;
...
version (Unicode) {
    alias OSVERSIONINFO = OSVERSIONINFOW;
    alias OSVERSIONINFOEX = OSVERSIONINFOEXW;
} else {
    alias OSVERSIONINFO = OSVERSIONINFOA;
    alias OSVERSIONINFOEX = OSVERSIONINFOEXA;
}

alias POSVERSIONINFO = OSVERSIONINFO*;
alias LPOSVERSIONINFO = OSVERSIONINFO*;
alias POSVERSIONINFOEX = OSVERSIONINFOEX*;
alias LPOSVERSIONINFOEX = OSVERSIONINFOEX*;
...
enum WORD IMAGE_NT_OPTIONAL_HDR_MAGIC = IMAGE_NT_OPTIONAL_HDR64_MAGIC;
    ...
    alias IMAGE_ORDINAL_FLAG = IMAGE_ORDINAL_FLAG64;
    alias IMAGE_SNAP_BY_ORDINAL = IMAGE_SNAP_BY_ORDINAL64;
    alias IMAGE_ORDINAL = IMAGE_ORDINAL64;
...
enum WORD IMAGE_NT_OPTIONAL_HDR_MAGIC = IMAGE_NT_OPTIONAL_HDR32_MAGIC;
    ...
    alias IMAGE_ORDINAL_FLAG = IMAGE_ORDINAL_FLAG32;
    alias IMAGE_ORDINAL = IMAGE_ORDINAL32;
    alias IMAGE_SNAP_BY_ORDINAL = IMAGE_SNAP_BY_ORDINAL32;
...
alias PIMAGE_OPTIONAL_HEADER = IMAGE_OPTIONAL_HEADER*;
alias PIMAGE_NT_HEADERS = IMAGE_NT_HEADERS*;
alias PIMAGE_THUNK_DATA = IMAGE_THUNK_DATA*;
alias PIMAGE_TLS_DIRECTORY = IMAGE_TLS_DIRECTORY*;
