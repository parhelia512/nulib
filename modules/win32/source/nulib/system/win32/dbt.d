...
alias PDEV_BROADCAST_HDR = DEV_BROADCAST_HDR*;
...
alias PDEV_BROADCAST_OEM = DEV_BROADCAST_OEM*;
...
alias PDEV_BROADCAST_PORT_A = DEV_BROADCAST_PORT_A*;
...
alias PDEV_BROADCAST_PORT_W = DEV_BROADCAST_PORT_W*;
...
alias PDEV_BROADCAST_VOLUME = DEV_BROADCAST_VOLUME*;

version (Unicode) {
    alias DEV_BROADCAST_PORT = DEV_BROADCAST_PORT_W;
} else {
    alias DEV_BROADCAST_PORT = DEV_BROADCAST_PORT_A;
}
alias PDEV_BROADCAST_PORT = DEV_BROADCAST_PORT*;
...
//static if (_WIN32_WINNT >= 0x500) {
    ...
    alias PDEV_BROADCAST_DEVICEINTERFACE_W = DEV_BROADCAST_DEVICEINTERFACE_W*;

    version (Unicode) {
        alias DEV_BROADCAST_DEVICEINTERFACE = DEV_BROADCAST_DEVICEINTERFACE_W;
    } else {
        alias DEV_BROADCAST_DEVICEINTERFACE = DEV_BROADCAST_DEVICEINTERFACE_A;
    }
    alias PDEV_BROADCAST_DEVICEINTERFACE = DEV_BROADCAST_DEVICEINTERFACE*;
    ...
    alias PDEV_BROADCAST_HANDLE = DEV_BROADCAST_HANDLE*;
//}
